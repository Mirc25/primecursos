...
#!perl
#line 29
    eval 'exec C:\Users\stefa\Desktop\CARPETA WORDPRES\XAMPP\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\stefa\Desktop\CARPETA WORDPRES\XAMPP\perl\bin\perl.exe';
